...
Acai Bowl                  bowl        19                180.50
Yogurt Bowl                bowl         9                 78.75
...
--          grouped by hour of day across all orders. Use HAVING to
--          show only hours with more than 0 orders.
...
bowl       Acai Bowl                  180.50          19
bowl       Yogurt Bowl                 78.75           9
bowl       (null)                     259.25          28    <- category subtotal
...
/*
Expected output (before update):
No staff member receives from ALL 40 suppliers in the base data.
After update script adds supplier 41, result stays empty unless data extended.
...
-- English: Show bowl menu items whose price is above the average price
...
-- Satisfies: nested subquery, LIKE, ORDER BY, FETCH FIRST N ROWS ONLY
-- =============================================================
SELECT m.product_name,
       m.category,
       m.price,
